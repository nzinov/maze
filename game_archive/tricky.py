...
> RubberRoom(RIGHT)
< RubberRoom(LEFT)
Q RubberRoom(RIGHT, messages={"arrive": "Вы слышите РЫК МИНОТАВРА!"})
I RubberRoom(UP, messages={"arrive": "Вы слышите РЫК МИНОТАВРА!"})
...
S EffectorSquare(lambda: Stun(3, -25), messages={"arrive": "Вы попали в ловушку!"})
